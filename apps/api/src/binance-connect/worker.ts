...
export function invokeWorker<T>(options: WorkerBinaryOptions, subcommand: "connect" | "status" | "list" | "rename" | "sync" | "series" | "trades" | "nav" | "performance" | "prove-performance" | "collector-identity" | "disconnect", stdinPayload: string): Promise<T> {
